    ...
    render() {
        return (
            <Fragment >
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="box">
                                        <i><img src="images/offer.webp" alt="offer" /></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                {/* <!--=============/Slide Offers===========--> */}
                {/* <!--=============Offers List Data===========--> */}
                <section class="offerlistdata">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="nav nav-tabs">
                                    <a class="nav-item nav-link active" data-toggle="tab" href="#resturant-offers">Restaurant offers</a>
                                    <a class="nav-item nav-link" data-toggle="tab" href="#payment-offers">Payment offers/Coupons</a>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active row" id="resturant-offers">
                                        <div class="col-sm-12">
                                            <h2>All offers (109)</h2>
                                            <p class="offertagline">All offers and deals, from restaurants near you</p>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <a href="" class="returant-name">
                                                <div class="data">
                                                    <i class="qimage"><img src="images/1.jpg" alt="Poha" class="w-100" /></i>
                                                    <h3>Kanha Bhog Poha &amp; Lassi</h3>
                                                    <p class="tagline">Snacks, Beverages, Desserts</p>
                                                    <div class="d-flex justify-content-between">
                                                        <span class="rating green"><i class="icon-star"></i> 4.4</span>
                                                        <span class="qtext">49 MINS</span>
                                                        <span class="qtext">₹100 FOR TWO</span>
                                                    </div>
                                                    <div class="roffer">
                                                        <i class="icon-offer-filled"></i>
                                                        <p>5% off on all orders</p>
                                                    </div>
                                                    <div class="qview">Quick View</div>
                                                </div>
                                            </a>
                                            <a href="" class="returant-name">
                                                <div class="data">
                                                    ...
                                                    <p class="tagline">Snacks, Beverages, Desserts</p>
                                                    <div class="d-flex justify-content-between">
                                                        <span class="rating brown"><i class="icon-star"></i> 4.4</span>
                                                        <span class="qtext">49 MINS</span>
                                                        <span class="qtext">₹100 FOR TWO</span>
                                                    </div>
                                                    <div class="roffer">
                                    ...
                                    <div class="tab-pane fade row" id="payment-offers">
                                        <h2>Available Coupons</h2>
                                        <div class="row">
                                            <div class="col-xs-12 col-lg-4">
                                                <div class="paymentbox">
                                                    <span class="pheader"><img src="images/small-swiggy.webp" alt="" />BINGE50</span>
                                                    <h3>Get 50% OFF on your first Swiggy order</h3>
                                                    <p>Use code BINGE50 & get 50% off on your first Swiggy order. Maximum discount: Rs. 100</p>
