                                        ...
                                        <div className="col-xs-12 col-sm-3">
                                            <div className="greybox">
                                                <div className="nav nav-tabs">
                                                    <a className="nav-item nav-link active" data-toggle="tab" href="#legal">Legal</a>
                                                    <a className="nav-item nav-link" data-toggle="tab" href="#FAQs">FAQs</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-xs-12 col-sm-9 gcollapse">
                                            <div className="tab-content" id="nav-tabContent">
                                                <div className="tab-pane fade show active row" id="legal">
                                                    <div className="col-sm-12">
                                                        <h2>Legal</h2>
                                                        <div className="accordion" id="accordionExample">
                                                            <div className="card">
                                                                <a className="card-header" id="headingOne" type="button" data-toggle="collapse" data-target="#collapseOne">
                                                                    Terms of Use
												</a>
                                                            ...
                                                            <div className="card">
                                                                <a className="card-header" id="headingTwo" type="button" data-toggle="collapse" data-target="#collapseTwo">
                                                                    Privacy Policy
												</a>
                                                            ...
                                                            <div className="card">
                                                                <a className="card-header" id="headingThree" type="button" data-toggle="collapse" data-target="#collapseThree">
                                                ...
                                                <div className="tab-pane fade row" id="FAQs">
                                                    <div className="col-sm-12">
                                                        <h2>FAQs</h2>
                                                    </div>
                                                </div>
